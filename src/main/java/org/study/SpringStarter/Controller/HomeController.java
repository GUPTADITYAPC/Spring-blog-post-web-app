...
public class HomeController {
    ...
    public String home(Model model,
        ...
        Page<Post> posts_on_page = postService.findAll(Integer.parseInt(page) - 1, Integer.parseInt(per_page),
                sort_by);
        ...
        if (pages != null) {
            for (int link : pages) {
                ...
                links.add(
                        "<li class=\"page-item " + active + "\"><a href=\"" + _temp_link + "\" class ='page-link'>"
                                + (link + 1)
                                + "</a></li>");
            }
